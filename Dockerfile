...
# Installing Latest Hashicorp Terraform (v0.12.8)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.8/terraform_0.12.8_linux_amd64.zip > terraform_0.12.8_linux_amd64.zip && \
    unzip terraform_0.12.8_linux_amd64.zip -d /bin && \
