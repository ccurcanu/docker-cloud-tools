...
# Installing Latest Hashicorp Terraform (v0.14.0)
RUN curl -s https://releases.hashicorp.com/terraform/0.14.0/terraform_0.14.0_linux_amd64.zip > terraform_0.14.0_linux_amd64.zip && \
    unzip terraform_0.14.0_linux_amd64.zip -d /bin && \
    rm -f terraform_0.14.0_linux_amd64.zip
