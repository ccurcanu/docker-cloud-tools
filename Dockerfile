...
# Installing Latest Hashicorp Terraform (v0.14.3)
RUN curl -s https://releases.hashicorp.com/terraform/0.14.3/terraform_0.14.3_linux_amd64.zip > terraform_0.14.3_linux_amd64.zip && \
    unzip terraform_0.14.3_linux_amd64.zip -d /bin && \
