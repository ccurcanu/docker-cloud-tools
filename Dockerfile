...
# Installing Latest Hashicorp Terraform (v0.12.14)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.14/terraform_0.12.14_linux_amd64.zip > terraform_0.12.14_linux_amd64.zip && \
    unzip terraform_0.12.14_linux_amd64.zip -d /bin && \
    rm -f terraform_0.12.14_linux_amd64.zip


# Installing Latest Hashicorp Packer (v1.4.5)
RUN cd /tmp \
    && wget -q https://releases.hashicorp.com/packer/1.4.5/packer_1.4.5_linux_amd64.zip \
    && unzip packer_1.4.5_linux_amd64.zip \
    && mv packer /usr/local/bin/ \
    && rm -rf packer_1.4.5_linux_amd64.zip
