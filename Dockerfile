...
# Installing Latest Hashicorp Terraform (v0.14.7)
RUN curl -s https://releases.hashicorp.com/terraform/0.14.7/terraform_0.14.7_linux_amd64.zip > terraform_0.14.7_linux_amd64.zip && \
