...
# Installing Latest Hashicorp Terraform (v0.12.21)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.21/terraform_0.12.21_linux_amd64.zip > terraform_0.12.21_linux_amd64.zip && \
