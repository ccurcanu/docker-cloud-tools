...
# Installing Latest Hashicorp Terraform (v0.14.9)
RUN curl -s https://releases.hashicorp.com/terraform/0.14.9/terraform_0.14.9_linux_amd64.zip > terraform_0.14.9_linux_amd64.zip && \
    unzip terraform_0.14.9_linux_amd64.zip -d /bin && \
