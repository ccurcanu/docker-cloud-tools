...
# Installing Latest Hashicorp Terraform (v0.13.5)
RUN curl -s https://releases.hashicorp.com/terraform/0.13.5/terraform_0.13.5_linux_amd64.zip > terraform_0.13.5_linux_amd64.zip && \
