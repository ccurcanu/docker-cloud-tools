...
# Installing Latest Hashicorp Terraform (v0.12.19)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.19/terraform_0.12.19_linux_amd64.zip > terraform_0.12.19_linux_amd64.zip && \
    unzip terraform_0.12.19_linux_amd64.zip -d /bin && \
