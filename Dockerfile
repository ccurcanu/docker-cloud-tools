...
# Installing Latest Hashicorp Terraform (v0.11.19)
RUN curl -s https://releases.hashicorp.com/terraform/0.11.19/terraform_0.11.19_linux_amd64.zip > terraform_0.11.19_linux_amd64.zip && \
    unzip terraform_0.11.19_linux_amd64.zip -d /bin && \
    rm -f terraform_0.11.19_linux_amd64.zip


# Installing Latest Hashicorp Packer (v1.5.1)
RUN cd /tmp \
