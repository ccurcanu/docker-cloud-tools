...
# Installing Latest Hashicorp Terraform (v1.0.0)
RUN curl -s https://releases.hashicorp.com/terraform/1.0.0/terraform_1.0.0_linux_amd64.zip > terraform_1.0.0_linux_amd64.zip && \
