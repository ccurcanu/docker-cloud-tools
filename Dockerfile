...
# Installing Latest Hashicorp Terraform (v0.12.22)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.22/terraform_0.12.22_linux_amd64.zip > terraform_0.12.22_linux_amd64.zip && \
    unzip terraform_0.12.22_linux_amd64.zip -d /bin && \
    rm -f terraform_0.12.22_linux_amd64.zip


# Installing Latest Hashicorp Packer (v1.5.4)
RUN cd /tmp \
    && wget -q https://releases.hashicorp.com/packer/1.5.4/packer_1.5.4_linux_amd64.zip \
