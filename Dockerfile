...
# Installing Latest Hashicorp Terraform (v0.15.0)
RUN curl -s https://releases.hashicorp.com/terraform/0.15.0/terraform_0.15.0_linux_amd64.zip > terraform_0.15.0_linux_amd64.zip && \
    unzip terraform_0.15.0_linux_amd64.zip -d /bin && \
