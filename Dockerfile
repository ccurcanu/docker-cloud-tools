...
# Installing latest stable Golang Go (go1.14.6)
RUN cd /tmp &&  \
...
# Installing Latest Hashicorp Terraform (v0.12.28)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.28/terraform_0.12.28_linux_amd64.zip > terraform_0.12.28_linux_amd64.zip && \
    unzip terraform_0.12.28_linux_amd64.zip -d /bin && \
