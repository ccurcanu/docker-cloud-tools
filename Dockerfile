...
# Installing Latest Hashicorp Terraform (v0.12.23)
RUN curl -s https://releases.hashicorp.com/terraform/0.12.23/terraform_0.12.23_linux_amd64.zip > terraform_0.12.23_linux_amd64.zip && \
